...
var calendar = new function () {
    ...
    this.getData = function(ready) {
        ready({
            ...
            data: {
                title: '',
                html: '<div class="list"><div class="list__title">Ближайшие события</div><div class="list__item">Прогон презентации Морнинг Френд - Сегодня о 12:20</div><div class="list__item">Оформить документы по коммандировке – 13:15</div><div class="list__item">Встреча с колегами – Сегодня в 14:26</div><div class="list__item">Начало презентаций – 17:25</div><div class="list__item">Ужин с друзьями – 20:32</div></div>'
            }
        });
