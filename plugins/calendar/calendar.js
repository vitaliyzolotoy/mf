...
var calendar = new function () {
    ...
    this.getData = function(ready) {
        ready({
            text: ['Ближайшие события', 'Прогон презентации Морнинг Френд', 'Сегодня в 12:20', 'Оформить документы по коммандировке', '13:15', 'Встреча с колегами', 'Сегодня в 14:26', 'Начало презентаций', '17:25'],
            data: {
                title: '',
                html: '<div class="plugin-icon"><i class="icon-big icon-calendar"></i></div><div class="list"><div class="list__title">Ближайшие события</div><div class="list__item">Прогон презентации Морнинг Френд - Сегодня в 12:20</div><div class="list__item">Оформить документы по коммандировке – 13:15</div><div class="list__item">Встреча с колегами – Сегодня в 14:26</div><div class="list__item">Начало презентаций – 17:25</div></div>'
            }
        });
